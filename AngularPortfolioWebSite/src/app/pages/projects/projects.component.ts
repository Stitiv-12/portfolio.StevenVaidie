  ...
  projects: Project[] = [
    {
      ...
      realisation: "Ce projet est en cours avec 6 autres personnes, en utilisant React-Native pour le front-end et Express pour les API.",
    ...
    },
    {
      ...
      objective: 'Mettre en œuvre les compétences en Laravel et PHP sur un projet concret de site e-commerce.',
    ...
    },
    {
      ...
      objective: 'Apprendre Go en créant un générateur de particules interactif à partir d\'images.',
      ...
      githubUrl: 'https://github.com/Stitiv-12/particle-generator'
    },
    {
      title: 'Puissance 4',
      ...
      githubUrl: 'https://github.com/Stitiv-12/puissance4'
    },
    {
      title: 'Pickomino',
      fragment: 'pickomino',
